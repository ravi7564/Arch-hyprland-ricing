...
Item {
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => {
                if (!data) { isMediaPlaying = false; return }
    ...
    Process { id: mediaPlayPauseProc; command: ["playerctl", "play-pause"] }

    // Timers & Connections
    Timer { interval: 200; running: true; repeat: true; onTriggered: windowProc.running = true }
    Timer { interval: 1000; running: true; repeat: true; onTriggered: mediaProc.running = true }
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text { text: "󱂬"; color: Theme.purple; font.pixelSize: 15; font.family: Theme.fontFamily }
                Text {
                    text: activeWindow
                    color: Theme.fg
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text { text: "󰎈"; color: Theme.green; font.pixelSize: 14; font.family: Theme.fontFamily }
                Text {
                    text: {
                        if (mediaTitle && mediaArtist) return mediaTitle + " - " + mediaArtist
                        else if (mediaTitle) return mediaTitle
                ...
                Rectangle {
                    ...
                    radius: 4; color: Theme.cyan; opacity: 0.2
                    Text {
                        text: mediaStatus === "Playing" ? "󰏤" : "󰐊"
                        color: Theme.cyan; font.pixelSize: 14; font.family: Theme.fontFamily
